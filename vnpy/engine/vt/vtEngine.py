...
from vnpy.event.eventEngine import Event, EVENT_LOG, EVENT_ORDER, EVENT_CONTRACT
from vnpy.utils.vtConstant import STATUS_ALLTRADED, STATUS_CANCELLED
from vnpy.utils.vtFunction import findDataPath
...
class MainEngine(object):
    ...
    def getGateway(self, gatewayName):
        ...
        if gatewayName in self.gatewayDict:
            ...
            self.writeLog(u'接口不存在：{gateway}'.format(gateway=gatewayName))
            return None
    ...
    def dbLogging(self, event):
        ...
        self.dbInsert(u'VnTrader_Log_Db', self.todayDate, d)
...
class DataEngine(object):
    """数据引擎"""
    contractFilePath = findDataPath('ContractData.vt')
