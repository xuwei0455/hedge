...
from vnpy.engine.uiBasicWidget import QtGui, QtCore, QtWidgets, BasicCell
...
class CtaEngineManager(QtWidgets.QWidget):
    ...
    def closeEvent(self, event):
        """关闭窗口时的事件"""
        reply = QtWidgets.QMessageBox.question(self, u'保存持仓',
                                               u'是否要保存策略持仓数据到数据库？', QtWidgets.QMessageBox.Yes |
